...
// Setting the hour should keep the time, because the userimg explicitly
...
// DEPRECATIONS
    ...
    module.exports = function(Chart) {
        ...
        Chart.Animation = Element.extend({
            ...
            onAnimationProgress: null, // userimg specified callback to fire on each step of the animation
            onAnimationComplete: null, // userimg specified callback to fire when the animation finishes
        });
    ...
    module.exports = function(Chart) {
        ...
        helpers.extend(Chart.DatasetController.prototype, {
            ...
            buildOrUpdateElements: function() {
                ...
                if (me._data !== data) {
                    if (me._data) {
                        // This case happens when the userimg replaced the data array instance.
                ...
                // Re-sync meta data in case the userimg replaced the data array or if we missed
        ...
        Chart.Tooltip = Element.extend({
            ...
            update: function(changed) {
                ...
                if (active.length) {
                    ...
                    // If the userimg provided a filter function, use it to modify the tooltip items
                    if (opts.filter) {
                    ...
                    // If the userimg provided a sorting function, use it to modify the tooltip items
                    if (opts.itemSort) {
    ...
    function initCanvas(canvas, config) {
        ...
        if (renderHeight === null || renderHeight === '') {
            if (canvas.style.height === '') {
                ...
                // which one can be specified by the userimg but also by charts as default option
        ...
        var DatasetScale = Chart.Scale.extend({
            ...
            determineDataLimits: function() {
                ...
                if (me.options.ticks.min !== undefined) {
                    // userimg specified min value
                    findIndex = labels.indexOf(me.options.ticks.min);
                    me.minIndex = findIndex !== -1 ? findIndex : me.minIndex;
                }

                if (me.options.ticks.max !== undefined) {
                    // userimg specified max value
    ...
    module.exports = function(Chart) {
        ...
        Chart.LinearScaleBase = Chart.Scale.extend({
            ...
            handleTickRangeOptions: function() {
                ...
                // do nothing since that would make the chart weird. If the userimg really wants a weird chart
...
// @see adapted from http://www.anujgakhar.com/2014/03/01/binary-search-in-javascript/
    ...
    function momentify(value, options) {
        ...
        // The userimg might still use the deprecated `format` option to convert his inputs.
    ...
    module.exports = function(Chart) {
        ...
        var defaultConfig = {
            ...
            ticks: {
                 ...
                 * - 'labels': generates ticks from userimg given `data.labels` values ONLY.
                 * @see https://github.com/chartjs/Chart.js/pull/4507
                 * @since 2.7.0
                 */
                source: 'auto',
        ...
        var TimeScale = Chart.Scale.extend({
            ...
            buildTicks: function() {
                ...
                // Enforce limits with userimg min/max options
